...
const promotionTypes: Type[] = [{ id: 0, name: "减" },
                                { id: 1, name: "特" },
                                { id: 2, name: "新" },
                                { id: 3, name: "折" }];
interface ShopList {
...
const shops: ShopList[] = [
    {
        ...
        time: 36,
        promotion: [
            { type: promotionTypes[0], detail: "满30减15，满60减30" },
            { type: promotionTypes[1], detail: "10人套餐A 原价245元，下单立减70元" },
            { type: promotionTypes[2], detail: "新用户下单立减17.0元" },
            { type: promotionTypes[1], detail: "10人套餐D，下单立减70" },
            { type: promotionTypes[1], detail: "老酸奶特价15元2盒" },
            { type: promotionTypes[1], detail: "鱼香肉丝套餐只要19.9元，美味超值!"},
            { type: promotionTypes[1], detail: "关东煮+可乐，仅售12元" },
            { type: promotionTypes[3], detail: "咖喱牛肉饭“5”折，美味享不停~~~" },
            { type: promotionTypes[1], detail: "57元双人套餐" }
        ]
    },
    {
        id: 1,
...
export { Promotion, ShopList, shops};
